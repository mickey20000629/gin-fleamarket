...
type IItemRepository interface {
	...
	Update(UupdateItem models.Item) (*models.Item, error)
...
func NewItemMemoryRepositry(items []models.Item) IItemRepository {
...
func (r *ItemMemoryRepository) Update(updateItem models.Item) (*models.Item, error) {
	//この下の部分のr.itemsの部分が少しわかりにくいのでもう少し考えてみる必要がある
